...
void CConfigReader::Flush()
{
	if (m_bCanFlush)
	{
		...
		{	
			stringstream strErrorMess;
			strErrorMess << ex.what() << " " << __FILE__ << " " << __LINE__ << " | at : " <<  "CConfigReader::Flush" << endl;
			CUtilities::WriteErrorLog(ERROR_MSG, strErrorMess.str());
		}
	}
}

void CConfigReader::Delete(const std::string& strGroup, const std::string& strProperty)
{
	...
	{	
		stringstream strErrorMess;
		strErrorMess << ex.what() << " " << __FILE__ << " " << __LINE__ << " | at : " <<  "CConfigReader::Delete" << endl;
		CUtilities::WriteErrorLog(ERROR_MSG, strErrorMess.str());
	}
}
