...
class CUtilities
{
	...
	public: 
		...
		static void WriteInfoLog(const std::string& strType, const std::string& strErrorMsg);
		static void WriteErrorLog(const std::string& strErrorMsg);
		static string FormatDateSuffixLogByDay(struct tm tm);
		static string FormatDateSuffixHistory(struct tm tm);
		static string GetDateSuffixHistory(int iPeriod);
		static string GetDateSuffixLogByDay();
		static vector<string> GetListZabbixProcessId(string strPathPattern, string strDatetime);
		...
		static IP_TYPE GetIPType(string strIP);
};
